...
"""autogenerated by genpy from respond/Odrive_commandRequest.msg. Do not edit."""
import codecs
import sys
...
class Odrive_commandRequest(genpy.Message):
  _md5sum = "ae937ab698a9cfa4cc9e4ad44e65496f"
  _type = "respond/Odrive_commandRequest"
...
"""
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_2i().pack(_x.command, _x.value))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.command, _x.value,) = _get_struct_2i().unpack(str[start:end])
      return self
...
def _get_struct_2i():
    ...
    return _struct_2i
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from respond/Odrive_commandResponse.msg. Do not edit."""
import codecs
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
...
class Odrive_commandResponse(genpy.Message):
  ...
  _type = "respond/Odrive_commandResponse"
  _has_header = False  # flag to mark the presence of a Header object
...
class Odrive_command(object):
  _type          = 'respond/Odrive_command'
  _md5sum = '91fd6849a5ae678705e41a8ee4fb22ea'
