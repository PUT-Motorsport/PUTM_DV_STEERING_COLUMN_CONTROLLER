...
class Odrive_commandRequest(genpy.Message):
  _md5sum = "318ccb9b7dd0c12ef8e53afc5d8ee6d7"
  _type = "steering/Odrive_commandRequest"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int32 send_command
"""
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (self.send_command,) = _get_struct_i().unpack(str[start:end])
      return self
...
class Odrive_command(object):
  ...
  _md5sum = 'f759aa4a1410da240c4e7c85431387ba'
