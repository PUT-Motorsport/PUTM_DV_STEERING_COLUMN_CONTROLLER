...
"""autogenerated by genpy from steering/Action1ActionFeedback.msg. Do not edit."""
import codecs
import sys
...
class Action1ActionFeedback(genpy.Message):
  _md5sum = "aae20e09065c3809e8a8e87c4c8953fd"
  _type = "steering/Action1ActionFeedback"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','steering/Action1Feedback']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Action1ActionFeedback, self).__init__(*args, **kwds)
      ...
      if self.feedback is None:
        self.feedback = steering.msg.Action1Feedback()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.feedback = steering.msg.Action1Feedback()
