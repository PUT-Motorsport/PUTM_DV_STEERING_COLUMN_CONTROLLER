...
"""autogenerated by genpy from steering/Action1ActionResult.msg. Do not edit."""
import codecs
import sys
...
class Action1ActionResult(genpy.Message):
  _md5sum = "1eb06eeff08fa7ea874431638cb52332"
  _type = "steering/Action1ActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','steering/Action1Result']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(Action1ActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = steering.msg.Action1Result()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = steering.msg.Action1Result()
