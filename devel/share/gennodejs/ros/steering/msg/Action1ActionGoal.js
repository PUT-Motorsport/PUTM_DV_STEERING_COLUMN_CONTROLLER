...
class Action1ActionGoal {
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Action1Goal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Action1ActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = Action1Goal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new Action1Goal()
    }
...
module.exports = Action1ActionGoal;
