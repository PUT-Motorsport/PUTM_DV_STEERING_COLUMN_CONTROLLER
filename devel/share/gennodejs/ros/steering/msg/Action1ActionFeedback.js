...
class Action1ActionFeedback {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('feedback')) {
        ...
        this.feedback = new Action1Feedback();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = Action1Feedback.serialize(obj.feedback, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new Action1ActionFeedback(null);
    ...
    data.feedback = Action1Feedback.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new Action1ActionFeedback(null);
    ...
    if (msg.feedback !== undefined) {
      resolved.feedback = Action1Feedback.Resolve(msg.feedback)
    }
    else {
      resolved.feedback = new Action1Feedback()
    }
...
module.exports = Action1ActionFeedback;
