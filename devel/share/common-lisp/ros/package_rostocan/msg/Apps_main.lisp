...
(cl:defmethod cl:initialize-instance :after ((m <Apps_main>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Apps_main)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name package_rostocan-msg:<Apps_main> is deprecated: use package_rostocan-msg:Apps_main instead.")))

(cl:ensure-generic-function 'pedal_position-val :lambda-list '(m))
(cl:defmethod pedal_position-val ((m <Apps_main>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package_rostocan-msg:pedal_position-val is deprecated.  Use package_rostocan-msg:pedal_position instead.")
  (pedal_position m))

(cl:ensure-generic-function 'counter-val :lambda-list '(m))
(cl:defmethod counter-val ((m <Apps_main>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package_rostocan-msg:counter-val is deprecated.  Use package_rostocan-msg:counter instead.")
  (counter m))

(cl:ensure-generic-function 'position_diff-val :lambda-list '(m))
(cl:defmethod position_diff-val ((m <Apps_main>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package_rostocan-msg:position_diff-val is deprecated.  Use package_rostocan-msg:position_diff instead.")
  (position_diff m))

(cl:ensure-generic-function 'device_state-val :lambda-list '(m))
(cl:defmethod device_state-val ((m <Apps_main>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader package_rostocan-msg:device_state-val is deprecated.  Use package_rostocan-msg:device_state instead.")
  (device_state m))
