...
(cl:defmethod cl:initialize-instance :after ((m <Desired_angle-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Desired_angle-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name steering-srv:<Desired_angle-request> is deprecated: use steering-srv:Desired_angle-request instead.")))
...
(cl:defmethod desired_steer_angle-val ((m <Desired_angle-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader steering-srv:desired_steer_angle-val is deprecated.  Use steering-srv:desired_steer_angle instead.")
...
(cl:defmethod cl:initialize-instance :after ((m <Desired_angle-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Desired_angle-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name steering-srv:<Desired_angle-response> is deprecated: use steering-srv:Desired_angle-response instead.")))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Desired_angle-response>)))
  ...
  "steering/Desired_angleResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Desired_angle-response)))
  "Returns string type for a service object of type 'Desired_angle-response"
  "steering/Desired_angleResponse")
