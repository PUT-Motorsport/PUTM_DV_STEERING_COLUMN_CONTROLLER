...
(cl:defmethod cl:initialize-instance :after ((m <Odrive_command-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Odrive_command-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name respond-srv:<Odrive_command-request> is deprecated: use respond-srv:Odrive_command-request instead.")))

(cl:ensure-generic-function 'command-val :lambda-list '(m))
(cl:defmethod command-val ((m <Odrive_command-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:command-val is deprecated.  Use respond-srv:command instead.")
  (command m))

(cl:ensure-generic-function 'values-val :lambda-list '(m))
(cl:defmethod values-val ((m <Odrive_command-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:values-val is deprecated.  Use respond-srv:values instead.")
  (values m))
...
(cl:defmethod cl:initialize-instance :after ((m <Odrive_command-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Odrive_command-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name respond-srv:<Odrive_command-response> is deprecated: use respond-srv:Odrive_command-response instead.")))

(cl:ensure-generic-function 'Axis_Error-val :lambda-list '(m))
(cl:defmethod Axis_Error-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Axis_Error-val is deprecated.  Use respond-srv:Axis_Error instead.")
  (Axis_Error m))

(cl:ensure-generic-function 'Axis_State-val :lambda-list '(m))
(cl:defmethod Axis_State-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Axis_State-val is deprecated.  Use respond-srv:Axis_State instead.")
  (Axis_State m))

(cl:ensure-generic-function 'Active_Errors-val :lambda-list '(m))
(cl:defmethod Active_Errors-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Active_Errors-val is deprecated.  Use respond-srv:Active_Errors instead.")
  (Active_Errors m))

(cl:ensure-generic-function 'Disarm_Reason-val :lambda-list '(m))
(cl:defmethod Disarm_Reason-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Disarm_Reason-val is deprecated.  Use respond-srv:Disarm_Reason instead.")
  (Disarm_Reason m))

(cl:ensure-generic-function 'Pos_Estimate-val :lambda-list '(m))
(cl:defmethod Pos_Estimate-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Pos_Estimate-val is deprecated.  Use respond-srv:Pos_Estimate instead.")
  (Pos_Estimate m))

(cl:ensure-generic-function 'Vel_Estimate-val :lambda-list '(m))
(cl:defmethod Vel_Estimate-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Vel_Estimate-val is deprecated.  Use respond-srv:Vel_Estimate instead.")
  (Vel_Estimate m))

(cl:ensure-generic-function 'Iq_Setpoint-val :lambda-list '(m))
(cl:defmethod Iq_Setpoint-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Iq_Setpoint-val is deprecated.  Use respond-srv:Iq_Setpoint instead.")
  (Iq_Setpoint m))

(cl:ensure-generic-function 'Iq_Measured-val :lambda-list '(m))
(cl:defmethod Iq_Measured-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Iq_Measured-val is deprecated.  Use respond-srv:Iq_Measured instead.")
  (Iq_Measured m))

(cl:ensure-generic-function 'FET_Temperature-val :lambda-list '(m))
(cl:defmethod FET_Temperature-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:FET_Temperature-val is deprecated.  Use respond-srv:FET_Temperature instead.")
  (FET_Temperature m))
...
(cl:defmethod Motor_Temperature-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Motor_Temperature-val is deprecated.  Use respond-srv:Motor_Temperature instead.")
  (Motor_Temperature m))

(cl:ensure-generic-function 'Vbus_Voltage-val :lambda-list '(m))
(cl:defmethod Vbus_Voltage-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Vbus_Voltage-val is deprecated.  Use respond-srv:Vbus_Voltage instead.")
  (Vbus_Voltage m))

(cl:ensure-generic-function 'Vbus_Current-val :lambda-list '(m))
(cl:defmethod Vbus_Current-val ((m <Odrive_command-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader respond-srv:Vbus_Current-val is deprecated.  Use respond-srv:Vbus_Current instead.")
  (Vbus_Current m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<Odrive_command-response>)))
  ...
  "respond/Odrive_commandResponse")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'Odrive_command-response)))
  "Returns string type for a service object of type 'Odrive_command-response"
  "respond/Odrive_commandResponse")
